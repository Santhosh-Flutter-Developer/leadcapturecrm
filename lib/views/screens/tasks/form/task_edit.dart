...
class _TaskEditState extends State<TaskEdit> {
  ...
  final List<EmployeeModel> _initialAssignees = [];
  List<String> _selectedCreatedBy = [];
  final List<EmployeeModel> _initialCreatedBy = [];
  List<String> _selectedObservers = [];
  final List<EmployeeModel> _initialObservers = [];
  List<String> _selectedParticipants = [];
  final List<EmployeeModel> _initialParticipants = [];
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Scaffold(
        appBar: FormWidgets.buildHeader(context: context, title: "Update Task"),
        body: FutureBuilder(
          future: _future,
                                  ...
                                  child: CustomSearchableDropdown<String>(
                                    ...
                                    onChangedList: (list) {
                                      for (var i in list) {
                                        ...
                                        if (emp.uid != null) {
                                          if (!_selectedAssignees.contains(
                                            emp.uid,
                                          )) {
